...
public class ExtractorOsh5 {
    ...
    private static void extractPart3() throws SQLException, IOException {
        ...
        rs[1] = s[1].executeQuery(ExcelExport.getSQLFromFile("./resources/sql/osh5/3/T21-T25.txt"));
        rs[1].first();

        ee.setValue("osh5", 4, "T", 21, rs[1].getInt(1));
        ee.setValue("osh5", 4, "T", 22, rs[1].getInt(2));
        ee.setValue("osh5", 4, "T", 23, rs[1].getInt(3));
        ee.setValue("osh5", 4, "T", 24, rs[1].getInt(4));
        ee.setValue("osh5", 4, "T", 25, rs[1].getInt(5));
    ...
    private static void extractPart9() throws SQLException, IOException {
        ...
        ee.setValue("osh5", 10, "X", 27, rs[1].getInt(7));
        ee.setValue("osh5", 10, "X", 28, rs[1].getInt(8));
        ee.setValue("osh5", 10, "X", 29, rs[1].getInt(9));
        ee.setValue("osh5", 10, "X", 30, rs[1].getInt(10));
        ee.setValue("osh5", 10, "X", 31, rs[1].getInt(11));
        ee.setValue("osh5", 10, "X", 32, rs[1].getInt(12));
        ee.setValue("osh5", 10, "X", 33, rs[1].getInt(13));
        ee.setValue("osh5", 10, "X", 34, rs[1].getInt(14));
        ee.setValue("osh5", 10, "X", 35, rs[1].getInt(15));
        ee.setValue("osh5", 10, "X", 36, rs[1].getInt(16));
        ee.setValue("osh5", 10, "X", 37, rs[1].getInt(17));
        ee.setValue("osh5", 10, "X", 38, rs[1].getInt(18));
        ee.setValue("osh5", 10, "X", 39, rs[1].getInt(19));
        ee.setValue("osh5", 10, "X", 40, rs[1].getInt(20));
        ee.setValue("osh5", 10, "X", 41, rs[1].getInt(21));
        ee.setValue("osh5", 10, "X", 42, rs[1].getInt(22));
        ee.setValue("osh5", 10, "X", 43, rs[1].getInt(23));
        ee.setValue("osh5", 10, "X", 44, rs[1].getInt(24));
        ee.setValue("osh5", 10, "X", 45, rs[1].getInt(25));
        ee.setValue("osh5", 10, "X", 46, rs[1].getInt(26));
        ee.setValue("osh5", 10, "X", 47, rs[1].getInt(27));
        ee.setValue("osh5", 10, "X", 48, rs[1].getInt(28));
        ee.setValue("osh5", 10, "X", 49, rs[1].getInt(29));
        ee.setValue("osh5", 10, "X", 50, rs[1].getInt(30));
        ee.setValue("osh5", 10, "X", 51, rs[1].getInt(31));
        ee.setValue("osh5", 10, "X", 52, rs[1].getInt(32));
        ee.setValue("osh5", 10, "X", 53, rs[1].getInt(33));
        ee.setValue("osh5", 10, "X", 54, rs[1].getInt(34));
        ...
        ee.setValue("osh5", 10, "Y", 27, rs[1].getInt(7));
        ee.setValue("osh5", 10, "Y", 28, rs[1].getInt(8));
        ee.setValue("osh5", 10, "Y", 29, rs[1].getInt(9));
        ee.setValue("osh5", 10, "Y", 30, rs[1].getInt(10));
        ee.setValue("osh5", 10, "Y", 31, rs[1].getInt(11));
        ee.setValue("osh5", 10, "Y", 32, rs[1].getInt(12));
        ee.setValue("osh5", 10, "Y", 33, rs[1].getInt(13));
        ee.setValue("osh5", 10, "Y", 34, rs[1].getInt(14));
        ee.setValue("osh5", 10, "Y", 35, rs[1].getInt(15));
        ee.setValue("osh5", 10, "Y", 36, rs[1].getInt(16));
        ee.setValue("osh5", 10, "Y", 37, rs[1].getInt(17));
        ee.setValue("osh5", 10, "Y", 38, rs[1].getInt(18));
        ee.setValue("osh5", 10, "Y", 39, rs[1].getInt(19));
        ee.setValue("osh5", 10, "Y", 40, rs[1].getInt(20));
        ee.setValue("osh5", 10, "Y", 41, rs[1].getInt(21));
        ee.setValue("osh5", 10, "Y", 42, rs[1].getInt(22));
        ee.setValue("osh5", 10, "Y", 43, rs[1].getInt(23));
        ee.setValue("osh5", 10, "Y", 44, rs[1].getInt(24));
        ee.setValue("osh5", 10, "Y", 45, rs[1].getInt(25));
        ee.setValue("osh5", 10, "Y", 46, rs[1].getInt(26));
        ee.setValue("osh5", 10, "Y", 47, rs[1].getInt(27));
        ee.setValue("osh5", 10, "Y", 48, rs[1].getInt(28));
        ee.setValue("osh5", 10, "Y", 49, rs[1].getInt(29));
        ee.setValue("osh5", 10, "Y", 50, rs[1].getInt(30));
        ee.setValue("osh5", 10, "Y", 51, rs[1].getInt(31));
        ee.setValue("osh5", 10, "Y", 52, rs[1].getInt(32));
        ee.setValue("osh5", 10, "Y", 53, rs[1].getInt(33));
        ee.setValue("osh5", 10, "Y", 54, rs[1].getInt(34));
